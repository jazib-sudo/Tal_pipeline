...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.fpn_strides = [scale_factor**i for i in range(
            fpn_start_level,1)]# backbone_arch[-1]+1)]
        
        self.reg_range = regression_range
        print(len(self.fpn_strides) , len(self.reg_range))
        ...
        self.neck = make_neck(
            fpn_type,
            **{
                'in_channels' : [embd_dim] * 1,#(backbone_arch[-1] + 1),
                'out_channel' : fpn_dim,
                'scale_factor' : scale_factor,
    ...
    def forward(self, video_list):
        ...
        #anurag change----------
        batched_inputs, batched_masks, label_masks, split_labels = self.preprocessing(video_list)
        print(batched_inputs.shape)

        # forward the network (backbone -> neck -> heads)
        feats, masks = self.backbone(batched_inputs, batched_masks)
        
        #print("feats",feats[0].shape,feats[1].shape,feats[2].shape,feats[3].shape,feats[4].shape,feats[5].shape)
        #print("masks",masks[0].shape,masks[1].shape,masks[2].shape,masks[3].shape,masks[4].shape,masks[5].shape,)
        fpn_feats, fpn_masks = self.neck(feats, masks)
        #print("fpn_feats",fpn_feats[0].shape,fpn_feats[1].shape,fpn_feats[2].shape,fpn_feats[3].shape,fpn_feats[4].shape,fpn_feats[5].shape)
        #print("fpn_masks",fpn_masks[0].shape,fpn_masks[1].shape,fpn_masks[2].shape,fpn_masks[3].shape,fpn_masks[4].shape,fpn_masks[5].shape,)
        ...
        #print("points",points[0].shape,points[1].shape,points[2].shape,points[3].shape,points[4].shape,points[5].shape,)
        ...
        #print("out_cls_logits",out_cls_logits[0].shape,out_cls_logits[1].shape,out_cls_logits[2].shape,out_cls_logits[3].shape,out_cls_logits[4].shape,out_cls_logits[5].shape)
        #print("out_offsets",out_offsets[0].shape,out_offsets[1].shape,out_offsets[2].shape,out_offsets[3].shape,out_offsets[4].shape,out_offsets[5].shape)
        ...
        if self.training:
            ...
            print("gt_cls_labels",gt_cls_labels[0].shape,gt_cls_labels[1].shape)
            print("gt_offsets",gt_offsets[0].shape,gt_offsets[1].shape)
            print("gt_segments",gt_segments[0].shape,gt_segments[1].shape)
            print("gt_labels",gt_labels[0].shape,gt_labels[1].shape)
